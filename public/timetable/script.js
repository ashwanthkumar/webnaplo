...
redips_init = function () {
	...
	rd.trash_ask = true;		// do not ask on delete
...
save = function () {
	...
	// and save content
	// alert(content);
	window.location.href = 'timetable_save.php?' + content;
};
...
report = function (subject) {
	...
	var day = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
		time = ['07:50', '08:40', '09:30', '10:20', '11:30', '12:20', '13:10',
		        '14:10', '15:00', '15:50', '16:00', '16:50', '17:40'],
		div = [],	// define array
